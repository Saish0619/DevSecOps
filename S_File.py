...
#print(run_ssl_checks('google.com'))
#run_ssl_checks('google.com')
...
def scan_and_export(sites, output_file="scan_results.txt"):
    ...
    for site in sites:
        try:
            ...
            results = run_ssl_checks(site)   # run your function
...
sites_to_scan = ["www.flrs.co.uk"]

scan_and_export(sites_to_scan, "ssl_scan_results.json")